package com.thebigcheese.tutorialmod.util.helpers;
...
public class KeyboardHelper 
{
	...
	{
		return InputMappings.isKeyDown(WINDOW, GLFW.GLFW_KEY_RIGHT_CONTROL) || InputMappings.isKeyDown(WINDOW, GLFW.GLFW_KEY_LEFT_CONTROL);
	}
	}
